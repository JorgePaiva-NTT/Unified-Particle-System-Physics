using System;
using Assets.Scripts.GPU.Sorting;
using UnityEngine;
...
namespace DefaultNamespace
{
        public class GridHash : IDisposable
    {
            ...
            ComputeShader gridHashingShader, ComputeShader bitonicSortShader)
        {
            ...
            sortEngine = new BitonicSort(TotalParticles, bitonicSortShader);

            //GridHashingShader = Resources.Load("GridHash") as ComputeShader;
            GridHashingShader = gridHashingShader;
        ...
        private void MapTable()
        {
            ...
            //Clear the previous tables values as not all locations will be written to when mapped.
            ...
            //For each hash cell find where the index map start and ends for that hash value.
