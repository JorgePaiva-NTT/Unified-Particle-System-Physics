...
namespace Assets.Scripts.GPU.Sorting
{
    public class BitonicSort : IDisposable
    {
        ...
        public BitonicSort(int count, ComputeShader bitonicSortShader)
        {
        ...
        public void Dispose()
        {
            STDUtils.Release(ref tempBuffer1);
            STDUtils.Release(ref tempBuffer2);
        }
