...
// sqrt(float) only returns the square root
// this function returns the cubic root fourt root etc.
// does not support negative numbers
// http://www.dummies.com/education/math/algebra/how-to-convert-square-roots-to-exponents/
float croot(float n, uint y) {
    return pow(n, 1 / y);
}

int croot(int n, uint y) {
    return pow(n, 1 / y);
}
